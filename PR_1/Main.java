...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.printf("%nСИМУЛЯЦІЯ ЗАПУЩЕНА (1 с реального = 5 хв симуляції)%n");
...
class Clock {
    ...
    /** Форматує рядок і оголошує комендантську годину при зміні часу **/
    public synchronized String formatted() {
        ...
        // Скидаємо прапорці, якщо настав новий день
        ...
        // 00:00 — початок комендантської години
        if (t.equals(LocalTime.of(0, 0)) && !curfewStartedAnnounced) {
            Logger.print(this, "Настала комендантська година");
            curfewStartedAnnounced = true;
        }

        // 05:00 — кінець комендантської години
        if (t.equals(LocalTime.of(5, 0)) && !curfewEndedAnnounced) {
