...
Просте пояснення: тут я отримую від користувача діапазон значень та розмір масиву. Також роблю обмеження, якщо значення виходять за межі.

---

# 2. Генерація випадкового масиву

Після введення параметрів я створюю масив випадкових дробових чисел у вказаному діапазоні.
...
Пояснення: масив випадкових чисел буде використовуватися для подальшої обробки потоками.
...
Пояснення: тут я "нарізаю" загальний масив на частини. Кожна частина працює незалежно в окремому потоці.

---

# 4. Асинхронна обробка (Callable)

Я створив окремий клас SquareArrayTask, який отримує частину масиву і повертає масив квадратів.
...
Пояснення простими словами: Callable рахує квадрат кожного числа у своїй частині масиву. Я додав невелику затримку, щоб було видно зміну статусів isDone.
